<template>
  <div>
    <van-tabbar v-model="tabberActive" @change="switchColumnBtn">
...
mounted(){
  //导航栏高亮
    this.tabberActive=Number(localStorage.getItem('inxState'))
},
  methods: {
    switchColumnBtn() {
      console.log(this.tabberActive);
      let _inx = this.tabberActive;
      switch (_inx) {
        case 0:
